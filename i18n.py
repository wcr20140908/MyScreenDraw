...
_BASE = {
    ...
    "ui_mode": ("界面样式", "Interface style", "Style d'interface", "Estilo de interfaz", "Oberflächenstil", "Стиль интерфейса", "인터페이스 스타일", "インターフェース"),
    "ui_classic": ("文字", "Text", "Texte", "Texto", "Text", "Текст", "텍스트", "文字"),
    "ui_icon": ("图标", "Icons", "Icônes", "Iconos", "Symbole", "Значки", "아이콘", "アイコン"),
